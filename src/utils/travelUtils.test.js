...
// Test 1: calculateRewardPoints
{
  ...
  console.log('[PASS] calculateRewardPoints passed');
}
...
// Test 2: formatCurrency
{
  ...
  console.log('[PASS] formatCurrency passed');
}
...
// Test 3: formatTripDate
{
  ...
  console.log('[PASS] formatTripDate passed');
}
...
// Test 4: buildGeminiPrompt
{
  ...
  console.log('[PASS] buildGeminiPrompt passed');
}
